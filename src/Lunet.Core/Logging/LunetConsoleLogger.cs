...
{
    public class LunetConsoleLogger : ILogger
    {
        ...
        static LunetConsoleLogger()
        {
            var logLevelString = GetLogLevelString(LogLevel.Information);
            _messagePadding = new string(' ', logLevelString.Length + _loglevelPadding.Length);
        }

        public LunetConsoleLogger(string name, Func<string, LogLevel, bool> filter, bool includeScopes)
        {
            if (name == null)
            {
        ...
        public virtual void WriteMessage(LogLevel logLevel, string logName, int eventId, string message)
        {
            ...
            lock (_lock)
            {
                ...
                WriteWithColor(
                    ...
                    loglevelString + _loglevelPadding,
                    newLine: false);
